...
Config.PreventHelpTextOverwrites = false
...
Config.Lang = {
    -- Notifications
    Notification = {
        OccupiedSit = "Cette place est déjà occupée !",
        OccupiedLay = "Vous ne pouvez pas vous allonger ici !",
        NoAvailable = "Aucune place n'est disponible !",
        NoFound = "Aucune place n'a été trouvée !",
        NoBedFound = "Rien pour s'allonger n'a été trouvé !",
        TooTilted = "Cette place est trop inclinée !",
        CannotReachSeat = "Vous ne pouvez pas atteindre cette place !",
        CannotSitInSeat = "Vous ne pouvez pas vous asseoir sur cette place !",
        CannotReachBed = "Vous ne pouvez pas atteindre ce lit/banc !",
        AlreadyAttemptingToSit = "Vous essayez déjà de vous asseoir !",
        AlreadyAttemptingToLay = "Vous essayez déjà de vous allonger !"
    },

    -- Chat Suggestions
    ChatSuggestions = {
        Sit = "S'asseoir sur le siège le plus proche",
        Lay = "S'allonger sur le lit/banc le plus proche"
    },

    -- Key Mapping
    KeyMapping = {
        -- %s is automatically replaced with the key they need to press.
        SitDown = "Appuyez sur %s pour vous asseoir",
        LayDown = "Appuyez sur %s pour vous allonger",
    ...
    KeyBindingDesc = {
        Keyboard = {
            SitDown = "S'asseoir - S'asseoir (siège) - Clavier",
            LayDown = "S'asseoir - S'allonger (lit/banc) - Clavier",
            GetUp = "S'asseoir - Se lever - Clavier"
        },
        PadAnalog = {
            SitDown = "S'asseoir - S'asseoir (siège) - Manette",
            LayDown = "S'asseoir - S'allonger (lit/banc) - Manette",
            GetUp = "S'asseoir - Se lever - Manette"
        }
    }
}
...
Config.PresetLocations = {
    ...
    gabz_marabunta = true,
    gabz_mba = true, -- Maze Bank Arena
    gabz_mrpd = true, -- Mission Row Police Deparment
